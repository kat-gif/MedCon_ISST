...
public class MedapiApplication {
	...
	public CommandLineRunner demo (ConsultaRepository repository) {
		return (args) -> {
            ...
            repository.save(new Consulta(1234567, "Katia Alvarado Pelaez", LocalTime.of(10,43,00), 1, "B",false,"Monica@medico.es","",null));
			repository.save(new Consulta(2345678, "Alvaro Martin Brito", LocalTime.of(10,50,00), 1, "B",true,"Monica@medico.es","",null));
			...
			repository.save(new Consulta(3345678, "Sara Torres Guzmán", LocalTime.of(11,10,00), 1, "A",false,"Juanfrancisco@medico.es","",null));
